...
THREE.TrackballControls = function ( object, domElement ) {
	...
	/////////////////////////////////////////////////////////////////////////////
	//custom function for zoom and rotate the ball
	this.zoomSphere = function(delta) {
		_zoomStart.y += delta * 0.01;
		_this.dispatchEvent( startEvent );
		_this.dispatchEvent( endEvent );
	}
	this.pressBall = function(x1, y1) {
		_this.getMouseProjectionOnBall( x1, y1, _rotateStart );
		_rotateEnd.copy(_rotateStart);
		_this.dispatchEvent( startEvent );
	}
	this.moveBall = function(x2, y2) {
		_this.getMouseProjectionOnBall( x2, y2, _rotateEnd );
	}
